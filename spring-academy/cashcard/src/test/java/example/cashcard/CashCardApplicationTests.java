...
class CashCardApplicationTests {
    ...
    @Test
    void shouldReturnAllCashCardsWhenListIsRequest() {
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
    ...
    void shouldNotAllowAccessToCashCardsTheyDoNotOwn() {
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .getForEntity("/cashcards/102", String.class); //Kumar2'is data
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
    ...
    void shouldUpdateAnExistingCashCard() {
        ...
        //Lo que el metodo necesita
        HttpEntity<CashCard> request = new HttpEntity<>(cashCardUpdate);
        //lo mismo que que hace getForEntity("/cashcards/99", String.class); (no existe el putForEntity)
    ...
    void shouldNotUpdateACashCardThatDoesNotExist() {
        CashCard uncknownCard = new CashCard(null, 19.99, null);
        HttpEntity<CashCard> request = new HttpEntity<>(uncknownCard);
        ResponseEntity<Void> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
